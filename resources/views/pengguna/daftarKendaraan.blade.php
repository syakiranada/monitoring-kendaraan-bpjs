            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4">{{ $item->merk }} {{ $item->tipe }}</td>
                        ...
                        <!-- <a href="{{ route('kendaraan.detail', $item->id_kendaraan) }}" 
                            ...
                            <a  href="{{ route('kendaraan.detail', $item->id_kendaraan) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Detail</a>
                        </td>
