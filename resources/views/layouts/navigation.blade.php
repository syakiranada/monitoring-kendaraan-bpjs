        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <div class="w-12 h-12">
                    <img 
                        alt="Logo" 
                        src="{{ asset('logo_simonas.png') }}" 
                        class="w-full h-full object-contain"
                    />
                </div>
                <div class="ml-2">
                    <h1 class="text-white text-2xl md:text-3xl font-bold">SiMonas</h1>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button 
                            ...
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-full text-black transition ease-in-out duration-150 hover:brightness-90">   
