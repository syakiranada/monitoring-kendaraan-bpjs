...
<x-app-layout>
    <div class="p-6">
        ...
        <!-- Button Back -->
        <a href="{{  route('admin.pengajuan-peminjaman.index', ['page' => request('page'), 'search' => request('search')])  }}" class="flex items-center text-blue-600 font-semibold hover:underline mb-5">
