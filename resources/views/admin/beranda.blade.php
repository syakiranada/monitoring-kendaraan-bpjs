...
<body class="bg-gray-100">
    <div class="max-w-none mx-auto p-4 md">
        ...
        <div class="p-3 md:p-4 mb-4 md:mb-6 border border-red-300 rounded-lg bg-red-50 shadow-md" role="alert">
            ...
            @if(count($peminjamanTerlambat) > 0)
                <div class="flex items-center gap-2 mb-2 md:mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-6 sm:size-6 text-red-700 alert-icon">
                    ...
                    <h3 class="text-base md:text-lg font-semibold text-red-800">Pengembalian Kendaraan Dinas Terlambat!</h3>
                </div>
                <div class="space-y-1 md:space-y-2 pl-2 mb-3 md:mb-4">
            ...
            @if(count($peminjamanAkanJatuhTempo) > 0)
                <div class="flex items-center gap-2 mb-2 md:mb-3">
                    ...
                    <h3 class="text-base md:text-lg font-semibold text-red-800">Pengembalian Kendaraan Dinas Dalam 3 Jam!</h3>
                </div>
                <div class="space-y-1 md:space-y-2 pl-2">
        ...
        <div class="p-3 md:p-4 mb-4 md:mb-6 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 shadow-md" role="alert">
            <div class="flex items-center gap-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-6 sm:size-6 alert-icon">
                    <path fill-rule="evenodd" d="M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495ZM10 5a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 10 5Zm0 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" clip-rule="evenodd" />
                </svg>
                <h3 class="text-base md:text-lg font-semibold">Segera Lakukan Cek Fisik Kendaraan Dinas!</h3>
            </div>
            <div class="space-y-1 md:space-y-2 pl-2">
                @foreach($butuhCekFisik as $index => $cek)
                <div class="flex items-start md:items-center gap-2">
                    <span class="text-yellow-600 bullet-point">•</span>
                    <p class="text-sm">
        ...
        <div class="flex items-center gap-2 mb-3 md:mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-6 card-icon">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <div class="p-3 md:p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50">
                <div class="flex items-center gap-2 mb-2 md:mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-6 text-gray-700 card-icon">
                    ...
                    <h3 class="text-base md:text-lg font-semibold text-gray-900">Pajak Kendaraan</h3>
                </div>
                <div class="space-y-2">
                    ...
                    <p class="text-sm text-gray-700">
                        ...
                        <br>
                        <span class="text-xs ml-4">{{ $deadline['kendaraan']->plat_nomor }} - {{ \Carbon\Carbon::parse($deadline['batas_waktu'])->locale('id')->translatedFormat('d F Y') }}</span>
                    </p>
                    @empty
            ...
            <div class="p-3 md:p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50">
                <div class="flex items-center gap-2 mb-2 md:mb-3">
                    ...
                    <h3 class="text-base md:text-lg font-semibold text-gray-900">Asuransi Kendaraan</h3>
                </div>
                <div class="space-y-2">
            ...
            <div class="p-3 md:p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50">
                <div class="flex items-center gap-2 mb-2 md:mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-6 text-gray-700 card-icon">
                        ...
                        <path d="M6 4.586l2.33 2.33a.452.452 0 0 1-.08.09L6.8 8.214 4.586 6H3.309a.5.5 0 0 1-.447-.276l-1.7-3.402a.5.5 0 0 1 .093-.577l.49-.49a.5.5 0 0 1 .577-.093l3.402 1.7A.5.5 0 0 1 6 4.586Z" />
                    </svg>
                    <h3 class="text-base md:text-lg font-semibold text-gray-900">Servis Kendaraan</h3>
                </div>
                <div class="space-y-2">
                    ...
                    @empty
                    <p class="text-sm text-gray-500 italic">Tidak ada servis yang akan jatuh tempo</p>
                    @endforelse
                </div>
            </div>
        </div>
