...
<div class="flex-1 p-10">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md w-1/3">
        ...
        <div class="mt-6 flex justify-between">
            ...
            <a href="{{ route('admin.servisRutin.edit', ['id' => $servis->id_servis_rutin]) }}" class="text-white px-4 py-2 rounded hover:bg-yellow-600 shadow-md" style="background-color: #f59e0b;">
                Edit
            </a>
        </div>  
    </div>
