    ...
    <div class="bg-white p-6 rounded-lg shadow-md w-full md:w-2/3 lg:w-1/2">
        ...
        <div class="space-y-3">
            ...
            <div class="grid" style="grid-template-columns: 30% 70%;">
                ...
                <span class="text-left">{{ $servis->tgl_servis ? \Carbon\Carbon::parse($servis->tgl_servis)->format('d-m-Y') : '-' }}</span>
            </div>
            <div class="grid" style="grid-template-columns: 30% 70%;">
            ...
            <div class="grid" style="grid-template-columns: 30% 70%;">
                ...
                @if($servis->bukti_fisik)
                    <a href="{{ asset('storage/' . $servis->bukti_fisik) }}" target="_blank" class="text-left text-blue-500 hover:underline">Lihat kondisi</a>
                @else
            ...
            <div class="grid" style="grid-template-columns: 30% 70%;">
                ...
                @if($servis->bukti_bayar)
                    <a href="{{ asset('storage/' . $servis->bukti_bayar) }}" target="_blank" class="text-left text-blue-500 hover:underline">Lihat bukti</a>
                @else
                    <span class="text-left text-gray-500">Tidak ada bukti</span>
                @endif
            </div>
