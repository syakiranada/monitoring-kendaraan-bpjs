                    ...
                    @forelse ($kendaraan as $item)
                        <tr class="bg-white border-b">
                            ...
                            <td class="flex space-x-2 px-6 py-4">
                                <a href="{{ route('admin.cek-fisik.create', ['id_kendaraan' => $item->id_kendaraan, 'page' => request()->query('page'), 'search' => request()->query('search')]) }}" class="text-blue-600 hover:underline">
                                    Catat
                                </a>
