            ...
            <div class="w-full max-w-lg bg-white p-8 rounded shadow-md">
                ...
                <form id="bbmForm" action="{{ route('admin.pengisianBBM.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="tglIsiBBM" name="tgl_isi" class="w-full p-2 border border-gray-300 rounded" max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Nominal</label>
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">Rp</span>
                            <input type="text" id="nominalInput" name="nominal" class="w-full pl-10 p-2 border border-gray-300 rounded" required>
                        </div>
