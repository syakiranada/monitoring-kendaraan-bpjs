                ...
                <tbody>
                    @forelse ($riwayatCekFisik as $item)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <!-- Button for "Detail" -->
                                <a href="{{ route('admin.riwayat.detail-cek-fisik', ['id' => $item->id_cek_fisik, 'page' => request()->query('page', 1), 'search' => request()->query('search')]) }}" class="text-blue-600 hover:underline">
                                    Detail
                                </a>
                            </td>
                        </tr>
