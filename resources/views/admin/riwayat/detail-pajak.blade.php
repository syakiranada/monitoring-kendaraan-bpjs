...
<a href="{{ route('admin.riwayat.pajak', ['page' => $currentPage, 'search' => request()->query('search', '')]) }}"
...
<h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-2">Detail Pajak</h2> 
