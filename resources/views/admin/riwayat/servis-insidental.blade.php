                ...
                <tbody>
                    @forelse ($riwayatServis as $item)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.riwayat.detail-servis-insidental', ['id' => $item->id_servis_insidental, 'page' => request()->query('page', 1), 'search' => request()->query('search')]) }}" class="font-medium text-blue-600 hover:underline">
                                    Detail
                                </a>
                            </td>
                        </tr>
