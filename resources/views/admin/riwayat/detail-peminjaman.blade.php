...
<x-app-layout>
    <div class="p-6">
        ...
        <input type="hidden" name="search" value="{{ request()->query('search') }}">
            <a href="{{ route('admin.riwayat.peminjaman', ['page' => request('page'), 'search' => request('search')]) }}" class="flex items-center px-5 py-2.5 text-gray-900 bg-white border border-gray-300 rounded-lg text-sm hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700">
        ...
        @if ($peminjaman->status_pinjam == 'Telah Dikembalikan')
            ...
            <div class="block p-6 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
