<x-app-layout>
    <div class="flex-1 p-10">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md w-1/3">
            ...
            <button type="button" onclick="window.location.href='{{ route('admin.riwayat.servis-insidental', ['page' => $currentPage]) }}'" class="bg-purple-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-purple-700 transition">
                Kembali
            </button> 
        </div>
    </div>
